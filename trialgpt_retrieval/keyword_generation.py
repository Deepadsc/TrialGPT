...
from common.utils import setup_model, generate_response, MODEL_MAPPING
...
def main(args):
    ...
    output_file = f"results/retrieval_keywords_{prefix}_{args.corpus}.json"
    with open(output_file, "w") as f:
        json.dump(outputs, f, indent=4)
    print(f"Results saved to {output_file}")
 
    # Save failed outputs
    failed_output_file = f"results/failed_retrieval_keywords_{prefix}_{args.corpus}.json"
