...
def parse_arguments():
    """
    Parse command-line arguments for the hybrid fusion retrieval script.
    ...
    # Required arguments
    parser.add_argument("corpus", help="Name of the corpus to use (e.g., trec_2021, sigir)")
    parser.add_argument("q_type", help="Type of query to use (e.g., gpt-4o-mini, raw, Clinician_A)")
    parser.add_argument("k", type=int, help="RRF constant for score calculation (e.g., 20)")
    parser.add_argument("bm25_wt", type=float, help="Weight for BM25 scores (e.g., 1.0)")
    parser.add_argument("medcpt_wt", type=float, help="Weight for MedCPT scores (e.g., 1.0)")
    ...
    parser.add_argument("--exclusion_threshold", type=float, default=0.3, 
                       help="Score threshold for exclusion (0-1)")
